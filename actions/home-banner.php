...
function go_portfolio_intro_section_output()
{
  ...
  $go_portfolio_btn_url_one = get_theme_mod('go_portfolio_btn_url_one', '#');
              ...
              <?php if ($go_portfolio_btn_url_one || $go_portfolio_btn_url_two) : ?>
                <div class="pc-intro-btns">
                  <?php if ($go_portfolio_btn_url_one) : ?>
                    ...
                    <a href="<?php echo esc_url($go_portfolio_btn_url_one); ?>" class="btn btn-hero hero-btn1"><?php echo esc_html($go_portfolio_btn_text_one); ?></a>
                  <?php endif; ?>
